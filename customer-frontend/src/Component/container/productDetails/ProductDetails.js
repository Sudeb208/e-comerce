...
function ProductDetails(props) {
    ...
    console.log(ProductDetail && ProductDetail.productPicture);
                ...
                <div className="flexRow">
                    <div className="verticalImageStack">
                        {ProductDetail.productPicture &&
                            ProductDetail.productPicture.map((thumb, index) => (
                                <div key={index} className="thumbnail">
                                    <img
                                        src={genaratePublicUrl(thumb.img)}
                                        alt={thumb.img}
                                    />
                                </div>
                            ))}
                        ...
                        <div className="productDescImgContainer">
                            <img
                                src={
                                    ProductDetail.productPicture &&
                                    genaratePublicUrl(
                                        ProductDetail.productPicture[0].img,
                                    )
                                }
                                alt={`${
                                    ProductDetail.productPicture &&
